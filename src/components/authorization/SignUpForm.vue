          ...
          >
            ...
            <v-col cols="12" md="6">
              <v-file-input
                ...
                v-model="profilePicture" label="Profile Picture"
              ></v-file-input>
            </v-col>
    ...
    >
      <div>
        <v-card-item class="px-8">
          ...
          <div class="mb-4"></div>
          <div class="text-h5 font-weight-light text-center">Its important to be honest for us to perform our magic.</div>
        </v-card-item>
        <v-card-item class="px-8">
